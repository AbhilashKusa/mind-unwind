        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-emerald-dark/90 backdrop-blur-md">
            <div ref={containerRef} className="bg-emerald-deep border border-gold/30 shadow-glow-gold p-8 w-full max-w-md relative overflow-hidden">
                ...
                <div className="flex justify-between items-center mb-8">
                    <h3 className="text-2xl font-serif text-gold">New Task</h3>
                ...
                <form onSubmit={onAdd} className="space-y-6">
                    <div className="group">
                        <label className="block text-xs font-bold uppercase text-gold-muted mb-2 tracking-widest">Title</label>
                        <input
                            autoFocus
                            type="text"
                    ...
                    {/* Priority Select */}
                    <div>
                        <label className="block text-xs font-bold uppercase text-gold-muted mb-2 tracking-widest">Priority</label>
                        <div className="flex gap-3">
                            {[Priority.High, Priority.Medium, Priority.Low].map(p => (
                                <button
                                    ...
                                    className={`flex-1 py-3 text-xs font-bold uppercase tracking-widest border transition-all duration-300 ${priority === p
